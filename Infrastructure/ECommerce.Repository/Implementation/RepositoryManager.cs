...
public class RepositoryManager : IRepositoryManager
{
    ...
    private readonly Lazy<IUserPermissionRepository> _userPermission;  // إضافة Lazy جديدة
    ...
    public RepositoryManager(RepositoryContext repository)
    {
        ...
        _userPermission = new Lazy<IUserPermissionRepository>(() => new UserPermissionRepository(repository)); // تهيئة Lazy
    }
    ...
    public IUserPermissionRepository UserPermissionRepository => _userPermission.Value; // إضافة الخاصية
