...
// using Core.Entities;
// using Core.Enum.OrderStatus;
// using Core.Enum.PaymentMethods;
...
//     private static PaymentMethods GetPaymentMethods(PaymentMethods method) => method;
...
//                 OrderId = Guid.Parse("1a2b3c4d-5e6f-4a70-8901-abcdef123456"),
//                 PayMethod = PaymentMethods.CreditCard, // CreditCard
//                 PaidAt = new DateTime(2025, 1, 15, 10, 35, 0, DateTimeKind.Utc),
...
//                 OrderId = Guid.Parse("2b3c4d5e-6f7a-4b80-9012-bcdef1234567"),
//                 PayMethod = PaymentMethods.CreditCard, // Wallet
//                 PaidAt = new DateTime(2025, 3, 20, 14, 50, 0, DateTimeKind.Utc),
//                 PayStatus = PaymentStatus.Success // Success
//             },
//             new Payment
//             {
...
//                 OrderId = Guid.Parse("3c4d5e6f-7a8b-4c90-0123-cdef12345678"),
//                 PayMethod = PaymentMethods.CreditCard, // CreditCard
//                 PaidAt = new DateTime(2025, 2, 10, 9, 20, 0, DateTimeKind.Utc),
//                 PayStatus = PaymentStatus.Success // Success
//             },
//             new Payment
//             {
...
//                 OrderId = Guid.Parse("4d5e6f7a-8b9c-4d01-1234-def123456789"),
//                 PayMethod = PaymentMethods.Wallet, // Wallet
//                 PaidAt = new DateTime(2025, 5, 5, 16, 5, 0, DateTimeKind.Utc),
    ...
    private static void SeedPayments(ModelBuilder modelBuilder)
    {
        var payments = new[]
        {
            ...
            new Payment
            {
                ...
                PayMethod = PaymentMethods.Wallet,
                PaidAt = new DateTime(2025, 3, 20, 14, 50, 0, DateTimeKind.Utc),
                PayStatus = PaymentStatus.Success
            },
            new Payment
